...
const App = () => {
          ...
          <a
            onClick={() => {
              currentLocation.length !== +i + 1
                ? setCurrentLocation(currentLocation.slice(0, +i + 1))
                : () => {};
            }}
            style={currentLocation.length !== +i + 1 ? { color: "red" } : {}}
          >
            {currentLocation[i]}
          </a>
          /
  ...
  let renderStructure = () => {
    ...
    currentStructure.forEach((e) => {
      if (e.isFile) {
        returnData.push(
          <div
            className="folder-holder border"
            onClick={() => {
              openFile(e.name);
            }}
          >
        ...
        returnData.push(
          <div className="folder-holder border">
            <a
              style={{ color: "red" }}
              onClick={() => {
                setCurrentLocation([...currentLocation, e.name]);
              }}
            >
              {" "}
              <img
  ...
  let uploadAFile = () => {
    ...
    fetch("api/file", { method: "POST", body: formData }).then((e) => {
      if (e.status === 200) {
        ...
        setCurrentStructure([
          ...oldStructure,
          { name: selectedFile.name, isFile: true },
        ]);
        setSelectedFile("");
        setCurrentOption(0);
      } else {
  ...
  return (
    <div>
      ...
      <div className="panel panel-default m-2 border p-2" id="folder-options">
        ...
        <div className="panel-body">
          <button
            ...
            onClick={() => {
              currentOption !== 1 ? setCurrentOption(1) : setCurrentOption(0);
            }}
          >
            Create a folder
          </button>
          <button
            className="btn btn-dark m-1"
            onClick={() => {
              currentOption !== 2 ? setCurrentOption(2) : setCurrentOption(0);
            }}
          >
            Rename a folder
          </button>
          <button
            className="btn btn-dark m-1"
            onClick={() => {
              currentOption !== 3 ? setCurrentOption(3) : setCurrentOption(0);
            }}
          >
            Remove a folder
          </button>
        ...
        <div className="panel-body p-1">
          ...
          >
            <div className="form-group">
              ...
              <input
                className="form-control"
                id="rename-folder-input-1"
                onKeyDown={(e) => {
                  let oldName = document.getElementById(
                    "rename-folder-input-1"
                  ).value;
                  let newName = document.getElementById(
                    "rename-folder-input-2"
                  ).value;
                  if (e.key === "Enter")
                    if (oldName !== "" && newName !== "")
                      fetch(`/api/folder`, {
                        ...
                        if (e.status === 200) {
                          let oldStructure = [...currentStructure];
                          oldStructure = oldStructure.filter(
                            (e) => e.name !== oldName
                          );
                          setCurrentStructure([
                            { name: newName, isFile: false },
                            ...oldStructure,
                          ]);
                          setCurrentOption(0);
          ...
          >
              ...
              <input
                ...
                onKeyDown={(e) => {
                  if (e.key === "Enter") {
                    ...
                    if (
                      document.getElementsByName("remove-folder-input")
                        .value !== ""
                    )
                      fetch(`/api/folder`, {
                        method: "DELETE",
            ...
            <button
              ...
              onClick={() => {
                ...
                if (
                  document.getElementsByName("remove-folder-input").value !== ""
                )
                  fetch(`/api/folder`, {
                    method: "DELETE",
                    body: JSON.stringify({
      ...
      <div className="panel panel-default m-2 border p-2" id="file-options">
        ...
        <div className="panel-body ">
          <button
            className="btn btn-dark m-1"
            onClick={() => {
              currentOption !== 4 ? setCurrentOption(4) : setCurrentOption(0);
            }}
          >
            Upload a file
          </button>
          <button
            className="btn btn-dark m-1"
            onClick={() => {
              currentOption !== 5 ? setCurrentOption(5) : setCurrentOption(0);
            }}
          >
            Rename a file
          </button>
          <button
            className="btn btn-dark m-1"
            onClick={() => {
              currentOption !== 6 ? setCurrentOption(6) : setCurrentOption(0);
            }}
          >
            Remove a file
          </button>
        ...
        <div className="panel-body p-1">
          ...
          >
            ...
            <button className="btn btn-dark" onClick={uploadAFile}>
              Upload!
            </button>
          </div>
          <div
            className="border p-2"
            id="file-rename-panel"
            style={{ display: currentOption == 5 ? "block" : "none" }}
          >
            <div className="form-group">
              <label htmlFor="create-folder-input">Old Name</label>
              <input
                className="form-control"
                id="rename-file-input-1"
                onKeyDown={(e) => {
                  let oldName = document.getElementById(
                    "rename-file-input-1"
                  ).value;
            ...
            <div className="form-group">
              <label htmlFor="rename-file-input-2">New name</label>
              <input
                className="form-control"
                id="rename-file-input-2"
                onKeyDown={(e) => {
                  let oldName = document.getElementById(
                    "rename-file-input-1"
                  ).value;
          ...
          <div
            className="border p-2"
            id="file-remove-panel"
            style={{ display: currentOption == 6 ? "block" : "none" }}
          >
            <div className="form-group">
              <label htmlFor="create-folder-input">File Name</label>
              <input
                className="form-control"
      ...
      <div
        id="file-text-content"
        className="panel panel-default m-2 border p-2"
      ></div>
    </div>
  );
};
